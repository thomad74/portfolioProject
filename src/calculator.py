#!/usr/bin/env python3
"""application.py  Python Program that gives the user options to use mathematical calulations. """
...
#TODO: Calculations
def numType(): # TypeError: unsupported operand type(s) for operation: 'NoneType' and 'NoneType'; 'num1' and 'num2'.
    num1 = int
    num2 - int

if operator == "+":
    output = numType(num1 + num2)
